...
- [sorkila/tintpad](https://github.com/sorkila/tintpad) - Native macOS hotkey palette that opens your terminal at the right repo with Codex already running in your chosen approval mode (untrusted, default, full access). Frecency-ranked repos, per-repo launch memory, git worktree launches. ![GitHub stars](https://img.shields.io/github/stars/sorkila/tintpad?style=flat-square)
